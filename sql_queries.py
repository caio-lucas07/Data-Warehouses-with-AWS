...
# Get redshift cluster credentials from the config file
...
time_table_create = ("""
                     ...
                     """)
####
#    FEEDING STAGING TABLES FROM S3 DATA (SONGS AND EVENT DATA)
####
staging_events_copy = ("""
...
####
#    QUERY LISTS to be used for the ETL process
####
